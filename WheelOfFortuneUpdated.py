...
print('\nWelcome to the Wheel of Fortune!\nThere will be three rounds, the first two will include our first two contestants and the player with the largest bank will move onto round three for a chance at the big prize.\nFor the first two rounds each player will spin the will and have a chance to guess a consonant, guess the word, or buy a vowel if they have $250 in thier round bank')
...
indices = [i for i, letter in enumerate(word_three) if letter == 'r']
for index in indices:
    word_list_three[index] ='r'
word_three_empty = ''.join(word_list_three)
#
word_list_three = list(word_three_empty)
indices = [i for i, letter in enumerate(word_three) if letter == 's']
for index in indices:
    word_list_three[index] ='s'
word_three_empty = ''.join(word_list_three)
#
word_list_three = list(word_three_empty)
indices = [i for i, letter in enumerate(word_three) if letter == 't']
for index in indices:
    word_list_three[index] ='t'
word_three_empty = ''.join(word_list_three)
#
word_list_three = list(word_three_empty)
indices = [i for i, letter in enumerate(word_three) if letter == 'l']
for index in indices:
    word_list_three[index] ='l'
word_three_empty = ''.join(word_list_three)
#
word_list_three = list(word_three_empty)
indices = [i for i, letter in enumerate(word_three) if letter == 'n']
for index in indices:
    word_list_three[index] ='n'
word_three_empty = ''.join(word_list_three)
#
word_list_three = list(word_three_empty)
indices = [i for i, letter in enumerate(word_three) if letter == 'e']
for index in indices:
    word_list_three[index] ='e'
word_three_empty = ''.join(word_list_three)
#
